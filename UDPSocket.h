...
#ifndef __DNSResolver__TCPSocket__
#define __DNSResolver__TCPSocket__
...
public:
    ...
    // Constructor to wrap a socket file descriptor with a UDPSocket object
    UDPSocket(int tcpSocketFD, struct sockaddr_storage& their_addr);
    
    // Constructor to setup a client socket to a given port and IP
    UDPSocket(string ipAddr, string port);
...
#endif /* defined(__DNSResolver__UDPSocket__) */
